...
Using Windows Updates is not recommended, because **it will revert tweaks**, **reinstall bloatware** and cause setbacks with respect to privacy and other pre-applied features, might even **break your OS**.
...
Instead, you might want to upgrade your ReviOS instance to a newer build. About that, you can read more here: [Upgrading ReviOS](faq/related/upgrade)
